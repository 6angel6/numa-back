...
export const reservationRepository = {
   ...
   list: (filters: {
      ...
      return Reservation.findAndCountAll({
         where,
         include: [{ model: RestaurantTable, as: 'table', attributes: ['id', 'number', 'zone'] }],
   ...
   updateStatus: (id: string, status: ReservationStatus, paidAt?: Date | null, transaction?: Transaction) =>
      Reservation.update(
